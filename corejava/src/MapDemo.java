...
public class MapDemo {
  ...
  Map <Integer,String> ob=new HashMap<>(); //It will accept integer as key and String as value

 // Map<Integer,String> ob=new LinkedHashMap();// based on Insertion order of key value

   // Map<Integer,String> ob=new TreeMap<>(); //sorted order based on keys
  ...
  /* Set <Integer>s1= ob.keySet(); // only keys
   ...
   int key= it1.next(); //Integer o= it1.next();
