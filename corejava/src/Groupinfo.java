 class Groupinfo extends Thread
 ...
 Thread t1 = new Thread( ) ; // as no group is specified, it is put into main group
...
System.out.println("Parent group of MyGroup is "+ group.getParent( ) ); //main
 ...
 System.out.println( "\nActive Number of threads in the group: " + group.activeCount()); // returns 0 as no active threads are running
...
Thread t2=new Thread(group,"MyThread1");
 ...
 } // If a thread is not given a name, by default JVM gives Thread-N( where N is

} // an integer number starting with 0
